...
public class JpaUtil {
    ...
    public static synchronized void createPersistenceFactory() {
        ...
        String schemaAction = System.getProperties().getOrDefault("DATABASE_SCHEMA_ACTION", "none").toString();
        ...
        propertyMap.put("jakarta.persistence.schema-generation.database.action", schemaAction);
